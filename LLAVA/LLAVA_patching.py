...
def main(task, samples, block_name, kind, mode, attn_head):
    ...
    temp_list = debug_hidden_flow(model, processor, df_correct, task, block_name=block_name, kind=kind, start=0, end=32, mode=mode, attn_head=attn_head, knockout=knockout, image_tensors=image_tensors)
